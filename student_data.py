...
while True:
    print("""
 Enter your choice For the factor you want to see

 1 : All Analysis
 2 : Study Time vs Marks
3 : Attendance vs Marks
4 : Parental Education vs Marks
5 : Internet Access vs Marks
6 : Previous Grade vs Marks
7 : Exit
""")
    try:
